...
const logo = "/assets/img/brand/logo.png"
const logolight = "/assets/img/brand/logo-light.png"
        ...
        <Container fluid className="main-container">
          <div className="main-header-left">
            ...
            <div className="hor-logo">
              <Link className="main-logo" href={`/components/dashboard/dashboard`}>
                ...
                <img src={logolight } className="header-brand-img desktop-logo-dark"
                  alt="logo" />
              </Link>
            </div>
          </div>
          <div className="main-header-center">
            <div className="responsive-logo">
              <Link to={`/components/dashboard/dashboard`}>
                <img
                  src={logo }
              ...
              >
                <div className="d-flex order-lg-2 align-items-center ms-auto">
                  ...
                  <div className="d-md-flex header-settings">
                    <Link to="#!" className="nav-link icon" onClick={() => openCloseSidebar()}
                    >
