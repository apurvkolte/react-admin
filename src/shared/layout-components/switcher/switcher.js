...
//Images
const free = "/assets/switcher/img/free.png"
const img16 = "/assets/switcher/img/16.jpg"
const img14 = "/assets/switcher/img/14.jpg"
const img15 = "/assets/switcher/img/15.jpg"
const moneybag = "/assets/switcher/img/money-bag.png"
                      ...
                      <div className="switch-toggle d-flex">
                        ...
                        <p className="onoffswitch2">
                          <input
                            ...
                            id="myonoffswitch01"
                            className="onoffswitch2-checkbox"
                            onClick={() => { SwitcherAction("VerticalMenu"), router("#") }}
                            defaultChecked
                          />
                          <label
                      ...
                      <div className="switch-toggle d-flex mt-2">
                        ...
                        <p className="onoffswitch2">
                          <input
                            ...
                            name="onoffswitch01"
                            id="myonoffswitch02"
                            onClick={() => { SwitcherAction("Horizontal"), router("#") }}
                            className="onoffswitch2-checkbox"
                          />
                          <label
                      ...
                      <div className="switch-toggle d-flex mt-2">
                        ...
                        <p className="onoffswitch2">
                          <input
                            ...
                            id="myonoffswitch03"
                            className="onoffswitch2-checkbox"
                            onClick={() => { SwitcherAction("HorizontalHoverMenu"), router("#") }}
                          />
                          <label
